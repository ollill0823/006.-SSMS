...
PRINT 'Part A create database and table Completed'
/********************************************************************************/
GO
...
---   B.6.1:  Create a stored procedure:sp_addEmployeeOffice  ---  
...
PRINT 'Part B create basic sp and function Completed'
/********************************************************************************/
GO
...
PRINT 'Part C import data Completed'
/********************************************************************************/
GO
...
PRINT 'Part D create views: vSoftwareArchive Completed'
/********************************************************************************/
GO
...
PRINT 'Part E create views: SoftwareArchive2 Completed'
/********************************************************************************/
GO
...
--- postal_codes was put in C:\db\us_postal_codes.csv --- 
...
PRINT 'Part F alter table, and insert postal code Completed'
/********************************************************************************/
GO
...
PRINT ''
PRINT 'Part G create check termination mechanism Completed'
